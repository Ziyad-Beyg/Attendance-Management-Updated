...
const AddStudenthtmlForm = () => {
  ...
  //   // let axiosPost = async() => {
  //     const cloudURI = "https://attendence-management-backend.herokuapp.com/student";
  //   // // let {res} = await axios.post(cloudURI, student)
  ...
  const submitValue = (e) => {
    ...
    axios.post(cloudURI, studentObj)
      .then((res) => {
